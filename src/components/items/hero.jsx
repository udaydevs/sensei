...
export default function Hero() {
    ...
    return (
        <div className="relative w-full h-screen flex flex-col items-center justify-end">
            <div className="absolute w-[98%] z-10 flex justify-end flex-col items-center h-screen bg-white bottom-0 left-1/2 transform -translate-x-1/2 rounded-tl-3xl  rounded-tr-3xl border">
                <Pattern />
                ...
                <div className="font-bold z-10 flex flex-col items-center text-6xl">
                    ...
                    <div className="text-[#1c1d26]">
                        with <span className="bg-gradient-to-r from-[#a17de9] via-[#ab90e0] to-[#d7d0e6] bg-clip-text text-transparent">AI Precision</span> Learning
                    </div>
                </div>
                ...
                <div className="flex mt-6 z-10 space-x-2">
                    <Button className="bg-black p-5 font-bold text-md text-white rounded-2xl" size="lg">
                        Start learning
                    </Button>
                    <Button className="text-md font-bold  p-5 rounded-2xl" size="lg" onClick={() => router.push('/chat')} variant="outline">
                        Try a chat
                    </Button>
                </div>

                <div className="relative z-9 mt-10 h-[50%] w-full flex justify-center overflow-hidden">
